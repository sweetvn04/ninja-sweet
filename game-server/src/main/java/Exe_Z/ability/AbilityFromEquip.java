...
public class AbilityFromEquip implements AbilityStrategy {
    ...
    public void setAbility(Char owner) {
        ...
        owner.damage += owner.options[73] + owner.options[87] + owner.options[76] + owner.options[168];
        ...
        owner.exactly += owner.options[10] + owner.options[18] + owner.options[75] + owner.options[86] + owner.options[116] + owner.options[166] + owner.optionsSupportSkill[12];
        ...
        owner.fatal = owner.options[14] + owner.options[37] + owner.options[69] + owner.options[92] + owner.options[114] + owner.optionsSupportSkill[14] + owner.options[167];
