...
import Exe_Z.event.LunarNewYear;
...
//    }
    ...
    public boolean process(Char p, String text) {
        ...
        if (text.equals("admin") && p.user.isAdmin()) {
            openUIAdmin(p);
            return true;
        }
...
//            return true;
//        }
//        if ((text.equals("createe122") && p.user.isAdmin()) || text.equals("wogdhh")) {
...
//                }
//            }
//            if (text.startsWith("addmobb1133")) {
