...
public class FashionFromEquip implements FashionStrategy {
    ...
    public void set(Char owner) {
        ...
        Equip vuKhi = owner.equipment[ItemTemplate.TYPE_VUKHI];
        if (owner.fashion[1] == null) {
            if (vuKhi != null) {
                short idFashion = vuKhi.template.fashion;
                if (idFashion > -1) {
                    owner.ID_WEA_PONE = idFashion;
                } else {
                    owner.ID_WEA_PONE = -1;
        ...
        if (owner.fashion[2] == null) {
            Equip Ao = owner.equipment[ItemTemplate.TYPE_AO ];
            if (Ao != null ) {
                short idFashion = Ao.template.fashion;
                if (idFashion > -1) {
                    owner.ID_BODY = idFashion;
                } else {
                    owner.ID_BODY = -1;
                }
            } else {
            ...
            Equip Quan = owner.equipment[ItemTemplate.TYPE_QUAN] ;
            if (Quan != null) {
                short idFashion = Quan.template.fashion;
                if (idFashion > -1) {
                    owner.ID_LEG = idFashion;
                } else {
                    owner.ID_BODY = -1;
                }
            } else {
            ...
            if (owner.ID_BODY != -1 && owner.ID_LEG != -1) {
                owner.ID_HAIR = (short) (Ao.template.fashion - 1);
            }
        }
