...
public class ItemTemplate {
    ...
    public static final int TYPE_VITHU1 = 35; 
    public static final int TYPE_VITHU2 = 36; 
    public static final int TYPE_VITHU3 = 37; 
    public static final int TYPE_VITHU4 = 38; 
    public int id;
    public String name;
    ...
    public boolean isTypeVT() {
        if (TYPE_VITHU1 <= this.type && this.type <= TYPE_VITHU4) {
            return true;
        }
        return false;
    }
