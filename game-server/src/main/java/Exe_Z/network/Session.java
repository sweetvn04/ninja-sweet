...
public class Session implements ISession {
    ...
    public AtomicInteger packetsSentInFiveSec = new AtomicInteger(0);
    ...
    public AtomicInteger getPacketsSentInFiveSec() {
        return packetsSentInFiveSec;
    }

    public void setLastPacketSentAt(long time) {
        this.lastPacketSentAt = time;
    }
